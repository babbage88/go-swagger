...
import (
	...
	"github.com/babbage88/go-swagger/examples/tutorials/custom-server/gen/restapi"
	"github.com/babbage88/go-swagger/examples/tutorials/custom-server/gen/restapi/operations"
)
