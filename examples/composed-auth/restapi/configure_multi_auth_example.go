...
import (
	...
	"github.com/babbage88/go-swagger/examples/composed-auth/restapi/operations"

	auth "github.com/babbage88/go-swagger/examples/composed-auth/auth"
	models "github.com/babbage88/go-swagger/examples/composed-auth/models"
)
