...
import (
	...
	"github.com/babbage88/go-swagger/examples/stream-server/client"
	"github.com/babbage88/go-swagger/examples/stream-server/client/operations"
	"github.com/babbage88/go-swagger/examples/stream-server/models"
