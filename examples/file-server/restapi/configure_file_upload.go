...
import (
	...
	"github.com/babbage88/go-swagger/examples/file-server/restapi/operations"
	"github.com/babbage88/go-swagger/examples/file-server/restapi/operations/uploads"
)
