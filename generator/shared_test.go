...
func TestDefaultImports(t *testing.T) {
	for i, toPin := range []struct {
	...
	}{
		{
			...
			Opts:  &GenOpts{},
			Expected: map[string]string{
				"models": "github.com/babbage88/go-swagger/generator/models",
			},
		},
		{
			...
			Expected: map[string]string{
				"ext":    "github.com/babbage88/go-swagger/generator/ext",
				"models": "github.com/babbage88/go-swagger/generator/models",
			},
		},
		{
		...
		},
		{
			...
			Expected: map[string]string{
				"bespoke": "github.com/babbage88/go-swagger/generator/target/bespoke",
			},
		},
		{
		...
		// issue #2362
		{
			...
			Expected: map[string]string{
				"bespoke": "github.com/babbage88/go-swagger/generator/target/bespoke",
				"auth":    "github.com/babbage88/go-swagger/generator/auth",
			},
		},
		{
		...
		},
		{
			...
			Expected: map[string]string{
				"models": "github.com/babbage88/go-swagger/generator/target/models",
				"auth":   "target/auth",
			},
		},
	} {
